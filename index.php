				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-info">
							...
							<b><h1>अन्नदान हेच ​​श्रेष्ठ दान</h1></b>
							<a href="about.php" class="hvr-rectangle-out button">.</a>
						</div>
		...
		<div class="mission-grids">
			...
			<div class="col-md-6 mission-right">
				<div class="mis-one">
					...
					<div class="mis-right">
						<h3>HELP & SUPPORT</h3>
						<p><b><h4>You little help can save a life</h4></b></p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="mis-one">
					...
					<div class="mis-right">
						...
						<p><b><h4>Nobody will die hungry</h4></b></p>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="mis-one">
					...
					<div class="mis-right">
						<h3>Helping Hand</h3>
						<p><b><h4><i>Shake hands with us for this noble Cause</i></h4></b></p>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
